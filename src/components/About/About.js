...
const About = () => {
    ...
    const image="https://scontent.fdac68-1.fna.fbcdn.net/v/t1.6435-9/121398945_115599533658465_4003791190849469563_n.jpg?_nc_cat=110&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=E_0w63WgtRIAX9zs6ow&_nc_ht=scontent.fdac68-1.fna&oh=ee88ed29d5feceda81cedf10dbd3fb13&oe=617EA015";
    ...
    return (
        <div className="text-center">
            ...
            <Image width="50%" src={image?image:""}/>
        </div>
    );
};
